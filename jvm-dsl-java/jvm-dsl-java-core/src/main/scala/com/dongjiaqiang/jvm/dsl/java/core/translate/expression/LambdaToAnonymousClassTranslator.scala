...
object LambdaToAnonymousClassTranslator {
    ...
    private def generateTupleParams(tupleType: TupleType, lambda: Lambda, javaTranslatorContext: JavaTranslatorContext): String = {
    ...
    private def generateTupleTypes(tupleType: TupleType, javaTranslatorContext: JavaTranslatorContext): String = {
        tupleType.parameterTypes.map(t⇒api.toJavaType(t,javaTranslatorContext) ).mkString( "," )
    }

    private def translateSupplier(outputType: DslType, lambda: Lambda, javaTranslatorContext: JavaTranslatorContext, visitor: ExpressionVisitor[String]): String = {
        outputType match {
            case UnitType ⇒
                s"""
    ...
    private def translatePredicate(inputType: DslType, lambda: Lambda, javaTranslatorContext: JavaTranslatorContext, visitor: ExpressionVisitor[String]): String = {
        inputType match {
            case IntType ⇒
                s"""
    ...
    private def translateConsumer(inputType: DslType, lambda: Lambda, javaTranslatorContext: JavaTranslatorContext, visitor: ExpressionVisitor[String]): String = {
        inputType match {
            case IntType ⇒
                s"""
    ...
    private def translateFunction(inputType: DslType, outputType: DslType, lambda: Lambda, javaTranslatorContext: JavaTranslatorContext, visitor: ExpressionVisitor[String]): String = {
        inputType match {
            case IntType ⇒
                outputType match {
                    case IntType ⇒

...
//
//
//        programScope.addScope( "ages", new FieldScope( 1,"ages", new MapType( StringType, IntType ),programScope ) )
...
//
//        //define filed ages
//        val agesField = new FieldScope( 1,"ages", new MapType( StringType, IntType ),programScope )
//        //define field addresses
//        val addressesField = new FieldScope( 2,"addresses", new MapType( StringType, StringType ), programScope,true )
//
